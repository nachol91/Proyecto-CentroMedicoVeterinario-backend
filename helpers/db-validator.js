...
const nivelExiste = async(id) =>{
    ...
    if(!existeNivel){
        throw new Error(`el id ${id} no corresponde al de ningun rol en la base de datos`)
    }
}
...
const usuarioExiste = async(id) =>{
    ...
    if(!existeUsuario){
        throw new Error(`el id ${id} no corresponde a un usuario registrado en la base de datos`)
    }
}
